...
plutos = [
    ...
    joinpath(repo_dir, "class07", "Kalman Filtering.html"),
    joinpath(repo_dir, "class07", "Linear Quadratic Guassian.html"),
    joinpath(repo_dir, "class07", "Robust Control.html"),
    joinpath(repo_dir, "class07", "Unscented Control.html"),
